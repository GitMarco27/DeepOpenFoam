...
class PointNetfeat(nn.Module):
    def __init__(self,
        ...
        self.conv1 = torch.nn.Conv1d(3, 64, 1)
        self.conv2 = torch.nn.Conv1d(64, 128, 1)
        self.conv3 = torch.nn.Conv1d(128, n_latents, 1)
        self.bn1 = nn.BatchNorm1d(64)
        self.bn2 = nn.BatchNorm1d(128)
        self.bn3 = nn.BatchNorm1d(n_latents)
    ...
    def forward(self, x):
        ...
        if self.global_feat:
            ...
            x = x.view(-1, self.n_latents, 1).repeat(1, 1, n_pts)
...
if __name__ == '__main__':
    ...
    cls = PointNetCls(k=5, feature_transform=True, n_latents=1024)
